  ...
  return (
    <div className='hero-parent w-full flex flex-col gap-12 relative' >
        ...
        <div className='flex opt-container justify-center w-full items-center' style={mode == 'black' ? { color: 'black' } : { color: 'black' }}>
          <section className='nunitoextralight_italic  flex items-center justify-center flex-col box-border w-2/4  gap-5 '>
            <h1 className='title-head flex justify-center items-center text-3xl font-bold text-lime-400 dancing_scriptregular ' >Deals of the Day</h1>
        ...
        <div className='flex flex-col justify-center items-center gap-4'>
          <section>
            <h1 className='title-head text-3xl font-bold text-lime-400 dancing_scriptregular text-center'>Todays Fresh</h1>
            <p className='title-des nunitoextralight_italic text-5xl font-extrabold text-center'>New Arrivals</p>
          </section>
        ...
        <div className='shop-now-p flex items-center justify-center gap-5 m-10' style={mode == 'black' ? { color: 'black' } : { color: 'black' }}>
          ...
          <div className='flex flex-col justify-center items-center w-3/6 shop-now-i gap-5'>
            <section className='nunitoextralight_italic  w-full hero-img2'>
            ...
            <section className='nunitoextralight_italic  w-full hero-img3'>
              <div className=' w-full flex flex-col gap-4 relative top-6  left-6'>
        ...
        <div className='service-p flex items-center justify-center gap-5 m-10'>
          ...
          <section className='service-block nunitoextralight_italic  w-3/6 flex flex-col gap-5 box-border'>
            ...
            <ul className='nunitoextralight_italic  flex flex-col gap-5 box-border'>
              {
                services.map((service, index) => {
                  return (
                    <li key={index} className='nunitoextralight_italic service-con flex gap-5 '>
                      <Image className=' size-20 ' src={service.img} alt="item image" width={300} height={300} />
              ...
              farmers.map((farmer, index) => {
                return (
                  <li style={mode == 'black' ? { color: 'black' } : { color: 'black' }} className='farmer-item  box-border p-5 gap-5 rounded-2xl farm-bg items-center' key={index}>
                    ...
                    <h1 className='nunitoextralight_italic farmers-name text-2xl mb-4  font-bold'>{farmer.name}</h1>
                    <span className=' mb-3  nunitoextralight_italic text-base font-normal text-stone-400'>{farmer.desc}</span>
