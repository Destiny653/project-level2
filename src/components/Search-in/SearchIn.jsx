  ...
  return (
    <>
      <label className='search-block ' htmlFor="text">
        <input value={searchValue} className='search-input w-full text-black' type="text" name='text' autoComplete='true' onChange={(e) => { setSeacrchValue(e.target.value); forceUpdate() }} />
